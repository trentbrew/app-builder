...
<Dialog.Portal>
	...
	<DialogPrimitive.Content
		...
		{transitionConfig}
		class={cn(
			'bg-background border-border fixed top-[50%] left-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border p-6 shadow-lg sm:rounded-lg md:w-full',
			className
		)}
		{...$$restProps}
	>
