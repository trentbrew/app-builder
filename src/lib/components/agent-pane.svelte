      ...
      {#snippet actions()}
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Content align="end" class="w-44">
            ...
            <DropdownMenu.Item onclick={showWip}>Agent logs</DropdownMenu.Item>
      ...
      <MessageScroller.Provider autoScroll defaultScrollPosition="last-anchor" scrollPreviousItemPeek={32}>
        ...
        <div class="agent-pane__chat">
          {#if isEmpty}
            ...
            {#if busy && statusLabel}
              <div class="agent-pane__status" role="status" aria-live="polite">
...
<style>
  ...
  .agent-pane__model-pill {
    ...
    background: var(--color-agent-composer-surface);
